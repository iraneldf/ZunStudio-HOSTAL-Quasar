...
import ReservaDialog from 'components/Reservas/ReservaDialog.vue'
...
const columns = [
  ...
  { name: 'Cliente.Ci', align: 'center', label: 'Ci del cliente', field: 'ciCliente', sortable: true },
  { name: 'Cliente.Nombre', align: 'center', label: 'Nombre del cliente', field: 'nombreCliente', sortable: true },
  { name: 'Habitacion.Numero', align: 'center', label: 'Habitación', field: 'numeroHabitacion', sortable: true },
  { name: 'llegadaCliente', align: 'center', label: 'Llegada del cliente', field: 'llegadaCliente', sortable: false },
  { name: 'action', align: 'center', label: 'Acciones', field: 'action', sortable: false }
]

// Hook de paginación
const { items, pagination, filter, onRequest, loadPaginate } = usePagination('Reserva')
